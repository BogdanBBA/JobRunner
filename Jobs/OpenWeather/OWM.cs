namespace Jobs.OpenWeather
{
    public static class OWM
    {
        ...
        /// </summary>
        internal const int REQUESTS_PER_RUN = 3;
        private const int MAX_REQUESTS_PER_MINUTE = 60;
        internal const int MAX_CITIES_PER_REQUEST = 20;

        /// <summary>
        /// The OWM request URL pattern, to be used in string.Format() with a comma-concatenated list of city IDs.
        /// </summary>
        internal const string WEATHER_REQUEST_URL = @"http://api.openweathermap.org/data/2.5/group?id={0}&APPID=" + API_KEY;
