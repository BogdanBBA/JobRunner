...
namespace Jobs.WebstoreProducts.Parsing
{
    public abstract class Parser
    {
        ...
        public void ParseProductPrice(WebClient web, ProductDTO product, out PriceDTO price, out string error)
        {
            try
            {
        ...
        public abstract PriceDTO ParseInternal(WebClient web, ProductDTO product, string page);

        protected void DownloadWebstoreProductThumbnail(WebClient web, ProductDTO product, string imageURL)
        {
